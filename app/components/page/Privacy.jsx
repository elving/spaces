  ...
  render() {
    return (
      <Layout className="page-basic">
        ...
        <p>If Spaces is involved in a merger, acquisition or asset sale, your Personal Information may be transferred. We will provide notice before your Personal Information is transferred and becomes subject to a different Privacy Policy.</p>
        <h3>Security</h3>
        ...
        <p>If you are located outside Puerto Rico and choose to provide information to us, please note that we transfer the information, including Personal Information, to Puerto Rico and process it there.</p>
