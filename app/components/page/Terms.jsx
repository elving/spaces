  ...
  render() {
    return (
      <Layout className="page-basic">
        ...
        <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by Spaces.</p>
        <p>Spaces has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Spaces shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
        ...
        <h3>Contact Us</h3>
        <p>If you have any questions about these Terms, please <a href="mailto:hello@joinspaces.co?Subject=Hello">contact us</a>.</p>
      </Layout>
    )
  }
}
